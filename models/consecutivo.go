...
type Consecutivo struct {
	...
	Contexto    int     `orm:"column(contexto)"`
...
// UpdateConsecutivo updates Consecutivo by Id and returns error if
// the record to be updated doesn't exist
func UpdateConsecutivoById(m *Consecutivo) (err error) {
	o := orm.NewOrm()
	v := Consecutivo{Id: m.Id}
...
// DeleteConsecutivo deletes Consecutivo by Id and returns error if
// the record to be deleted doesn't exist
func DeleteConsecutivo(id int) (err error) {
	o := orm.NewOrm()
	v := Consecutivo{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&Consecutivo{Id: id}); err == nil {
